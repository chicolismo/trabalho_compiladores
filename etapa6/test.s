...
__label_5__:
	...
	movl	__temp_3__(%rip), %ecx
	cmpl	$0, %ecx
	setne	%dl
	xorb	$-1, %dl
	andb	$1, %dl
	movzbl	%dl, %edx
	movl	%edx, __temp_4__(%rip)
...
__label_3__:
	...
	movslq	i(%rip), %rdx
	movl	(%rcx,%rdx,4), %eax
	movl	%eax, __temp_9__(%rip)
	leaq	L_.str(%rip), %rdi
	movl	__temp_9__(%rip), %esi
	movb	$0, %al
	callq	_printf
	leaq	L_.str2(%rip), %rdi
	movl	L_.str2(%rip), %esi
